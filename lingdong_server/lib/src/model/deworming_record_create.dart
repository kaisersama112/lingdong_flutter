...
part 'deworming_record_create.g.dart';
...
/// * [dewormingNextDate] 
@BuiltValue()
abstract class DewormingRecordCreate implements Built<DewormingRecordCreate, DewormingRecordCreateBuilder> {
  /// Pet Id，宠物ID
  ...
  DewormingRecordCreate._();

  factory DewormingRecordCreate([void updates(DewormingRecordCreateBuilder b)]) = _$DewormingRecordCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DewormingRecordCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DewormingRecordCreate> get serializer => _$DewormingRecordCreateSerializer();
}

class _$DewormingRecordCreateSerializer implements PrimitiveSerializer<DewormingRecordCreate> {
  @override
  final Iterable<Type> types = const [DewormingRecordCreate, _$DewormingRecordCreate];

  @override
  final String wireName = r'DewormingRecordCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    DewormingRecordCreate object, {
  ...
  void _deserializeProperties(
    ...
    required DewormingRecordCreateBuilder result,
  ...
  @override
  DewormingRecordCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DewormingRecordCreateBuilder();
