...
part of 'deworming_record_create.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DewormingRecordCreate extends DewormingRecordCreate {
  @override
  final int petId;
  @override
  ...
  factory _$DewormingRecordCreate(
          [void Function(DewormingRecordCreateBuilder)? updates]) =>
      (DewormingRecordCreateBuilder()..update(updates))._build();

  _$DewormingRecordCreate._(
      {required this.petId,
      ...
      : super._();
  @override
  DewormingRecordCreate rebuild(
          void Function(DewormingRecordCreateBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DewormingRecordCreateBuilder toBuilder() =>
      DewormingRecordCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DewormingRecordCreate &&
        petId == other.petId &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DewormingRecordCreate')
          ..add('petId', petId)
...
class DewormingRecordCreateBuilder
    implements Builder<DewormingRecordCreate, DewormingRecordCreateBuilder> {
  _$DewormingRecordCreate? _$v;
  ...
  DewormingRecordCreateBuilder() {
    DewormingRecordCreate._defaults(this);
  }

  DewormingRecordCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _petId = $v.petId;
  ...
  @override
  void replace(DewormingRecordCreate other) {
    _$v = other as _$DewormingRecordCreate;
  }

  @override
  void update(void Function(DewormingRecordCreateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DewormingRecordCreate build() => _build();

  _$DewormingRecordCreate _build() {
    final _$result = _$v ??
        _$DewormingRecordCreate._(
          petId: BuiltValueNullFieldError.checkNotNull(
              petId, r'DewormingRecordCreate', 'petId'),
          dewormingType: BuiltValueNullFieldError.checkNotNull(
              dewormingType, r'DewormingRecordCreate', 'dewormingType'),
