...
abstract class MediaCreate implements Built<MediaCreate, MediaCreateBuilder> {
  ...
  factory MediaCreate([void updates(MediaCreateBuilder b)]) = _$MediaCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MediaCreateBuilder b) => b
      ..sortOrder = 0;

  @BuiltValueSerializer(custom: true)
  static Serializer<MediaCreate> get serializer => _$MediaCreateSerializer();
}

class _$MediaCreateSerializer implements PrimitiveSerializer<MediaCreate> {
  @override
  final Iterable<Type> types = const [MediaCreate, _$MediaCreate];

  @override
  final String wireName = r'MediaCreate';
  ...
  void _deserializeProperties(
    ...
    required MediaCreateBuilder result,
  ...
  @override
  MediaCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MediaCreateBuilder();
