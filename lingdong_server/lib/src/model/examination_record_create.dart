...
part 'examination_record_create.g.dart';
...
/// * [nextCheckupDate] 
@BuiltValue()
abstract class ExaminationRecordCreate implements Built<ExaminationRecordCreate, ExaminationRecordCreateBuilder> {
  /// Pet Id，宠物ID
  ...
  ExaminationRecordCreate._();

  factory ExaminationRecordCreate([void updates(ExaminationRecordCreateBuilder b)]) = _$ExaminationRecordCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExaminationRecordCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExaminationRecordCreate> get serializer => _$ExaminationRecordCreateSerializer();
}

class _$ExaminationRecordCreateSerializer implements PrimitiveSerializer<ExaminationRecordCreate> {
  @override
  final Iterable<Type> types = const [ExaminationRecordCreate, _$ExaminationRecordCreate];

  @override
  final String wireName = r'ExaminationRecordCreate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExaminationRecordCreate object, {
  ...
  void _deserializeProperties(
    ...
    required ExaminationRecordCreateBuilder result,
  ...
  @override
  ExaminationRecordCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExaminationRecordCreateBuilder();
