...
class DynamicsApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseParentComment>> createParentCommentApiDynamicsPostsParentCommentsPost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponsePostListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponsePostListResponse>> getUserPostsApiDynamicsUsersUserIdPostsGet({ 
    required int userId,
    int? page = 0,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/dynamics/users/{user_id}/posts'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponseDict] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseDict>> likeReplyApiDynamicsCommentsReplyIdLikePost({ 
    required int replyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/dynamics/comments/{reply_id}/like'.replaceAll('{' r'reply_id' '}', encodeQueryParameter(_serializers, replyId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GenericResponseDict>> toggleLikeApiDynamicsCommentsLikePost({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (targetType != null) r'target_type': encodeQueryParameter(_serializers, targetType, const FullType(String)),
    };
