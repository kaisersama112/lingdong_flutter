...
class DynamicsApi {
  ...
  Future<Response<GenericResponseParentComment>> createParentCommentApiDynamicsPostsRepliesPost({ 
    ...
    final _path = r'/api/dynamics/posts/replies';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseReply>> createReplyApiDynamicsCommentsParentIdRepliesPost({ 
    ...
    final _path = r'/api/dynamics/comments/{parent_id}/replies'.replaceAll('{' r'parent_id' '}', encodeQueryParameter(_serializers, parentId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GenericResponseBool] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GenericResponseBool>> deleteReplyApiDynamicsRepliesReplyIdDelete({ 
    ...
    final _path = r'/api/dynamics/replies/{reply_id}'.replaceAll('{' r'reply_id' '}', encodeQueryParameter(_serializers, replyId, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
