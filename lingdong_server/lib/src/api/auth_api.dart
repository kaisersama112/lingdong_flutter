...
class AuthApi {
  ...
  Future<Response<GenericResponseEmptyResponse>> changePasswordApiAuthChangePasswordPost({ 
    ...
    final _path = r'/api/auth/change_password';
    ...
    GenericResponseEmptyResponse? _responseData;
    ...
    return Response<GenericResponseEmptyResponse>(
      data: _responseData,
  ...
  Future<Response<GenericResponsePhoneCodeLoginResponse>> phoneCodeLoginApiAuthPhoneCodeLoginPost({ 
    ...
    final _path = r'/api/auth/phone_code_login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GenericResponsePhoneCodeLoginResponse? _responseData;
    ...
    return Response<GenericResponsePhoneCodeLoginResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GenericResponsePhoneLoginResponse>> phonePasswordLoginApiAuthPhoneLoginPost({ 
    ...
    final _path = r'/api/auth/phone_login';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GenericResponsePhoneLoginResponse? _responseData;
    ...
    return Response<GenericResponsePhoneLoginResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GenericResponseUserInfoResponse>> readUsersMeApiAuthUsersMeGet({ 
    ...
    final _path = r'/api/auth/users/me/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GenericResponseUserInfoResponse? _responseData;
    ...
    return Response<GenericResponseUserInfoResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GenericResponseRefreshTokenResponse>> refreshAccessTokenApiAuthRefreshPost({ 
    ...
    GenericResponseRefreshTokenResponse? _responseData;
    ...
    return Response<GenericResponseRefreshTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GenericResponseSendCodeResponse>> sendLoginCodeApiAuthSendCodePost({ 
    ...
    final _path = r'/api/auth/send_code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GenericResponseSendCodeResponse? _responseData;
    ...
    return Response<GenericResponseSendCodeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GenericResponseEmptyResponse>> setPasswordByCodeApiAuthSetPasswordByCodePost({ 
    ...
    final _path = r'/api/auth/set_password_by_code';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
